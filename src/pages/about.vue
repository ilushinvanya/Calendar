...
f7-page(name="about")
	...
	f7-block(strong)
		p Жизнь кажется бесконечно длинной, а ее конец настолько же далек, как и тот час, когда солнце, исчерпав свой ресурс, в конце концов, перестанет светить.
		p Инфографика творит чудеса, представляя вещи, которые сложно понять, удерживая их в голове, в наглядном виде. Без лишних слов, давайте просто посмотрим, как выглядит наша жизнь в неделях:
	...
	f7-block
		...
		p Molestias et distinctio porro nesciunt ratione similique, magni doloribus, rerum nobis, aliquam quae reiciendis quasi modi. Nam a recusandae, fugiat in ea voluptates fuga eius, velit corrupti reprehenderit dignissimos consequatur!
		p Blanditiis, cumque quo adipisci. Molestiae, dolores dolorum quos doloremque ipsa ullam eligendi commodi deserunt doloribus inventore magni? Ea mollitia veniam nostrum nihil, iusto doloribus a at! Ea molestiae ullam delectus!
		f7-row
			f7-col(width="25")
				f7-button(
					fill
